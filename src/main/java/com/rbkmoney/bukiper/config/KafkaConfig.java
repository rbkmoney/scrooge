...
public class KafkaConfig {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, OperationLog> operationLogListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, OperationLog> factory = new ConcurrentKafkaListenerContainerFactory<>();

        DefaultKafkaConsumerFactory<String, OperationLog> consumerFactory = new DefaultKafkaConsumerFactory<>(
                consumerConfig(),
                new StringDeserializer(),
                new OperationLogDeserializer());
